...
export function NavSidebar({ navItems, footer, onNavigate }: NavSidebarProps) {
  ...
  return (
    <aside className="flex h-full w-64 flex-col bg-edu-surface-low shrink-0">
      ...
      {footer && <div className="border-t border-edu-outline-variant/20 p-4 mt-auto">{footer}</div>}
    </aside>
  );
}
